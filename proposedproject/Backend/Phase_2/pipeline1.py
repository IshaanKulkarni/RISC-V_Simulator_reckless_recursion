...
global last_checked_stall_line
...
def controller():
    ...
    while not Program_done:
        ...
        for i in range(5):
            ...
            #==============================================================WB
            if(pipeline_stages[4].data == None):
                Program_done = True
                break
            ...
            if len(pipeline_stages[2].data)<1:
                ...
                # return_statements.append("Executed EX on line "+str(instruction_word,instruction_line))
                ################################################################ID/RF
            ...
            if pipeline_stages[0].stalls_in_line :
                ...
                print("fetched line " , fetched_line)
    ...
    return_statements.append("Total Stalls: "+str(stalls))
